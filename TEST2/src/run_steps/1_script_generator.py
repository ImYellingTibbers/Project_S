...
- No repetition of recent imagery.
- Prefer POV or environmental storytelling.
- Only show narrator/entity as silhouette or partial unless necessary.
...
""".strip()
    ...
    if is_opening:
        opening_directive = (
            ...
            "- It must be immediately unsettling or visually wrong.\n"
            "- Prioritize unease, isolation, or violation over clarity.\n"
